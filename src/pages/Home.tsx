      ...
      <section className="relative w-full min-h-[85vh] sm:min-h-[90vh] flex items-center justify-center bg-gradient-to-br from-primary/15 via-background to-accent/15 overflow-hidden">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <Link to="/quiz">
              <Button size="lg" className="px-8 sm:px-12 md:px-16 py-6 sm:py-8 h-auto mb-6 sm:mb-8 bg-gradient-to-r from-primary via-accent to-secondary hover:scale-105 transition-all duration-300 shadow-2xl shadow-primary/30 text-primary-foreground font-bold text-lg sm:text-xl md:text-xl">
